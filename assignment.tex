...
\begin{align}
	...
	\pr {A^\prime B^\prime} &= \pr{A+B}^\prime \\&= 1 - \pr {A +B}\\
	&= 1 - 0.88 \\&= 0.12
\end{align}
\item We know that,
\begin{align}
    B + B^\prime &=1 \\ B B^\prime &= 0\\
	A &= A(B + B^\prime) = AB + A B^\prime \\
	\pr {A } &= \pr {AB} + \pr {A B^\prime} - \pr{ABB^\prime}\\ &= \pr{AB}+\pr{AB^\prime} \\ \implies \pr{AB^\prime} &= \pr A - \pr{AB}\\ &= 0.54 - 0.35 
	\\ &= 0.19
\end{align}
\item From eq. 17,
\begin{align}
