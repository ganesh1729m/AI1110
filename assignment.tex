...
\item We know that,
\begin{align}
	\pr {A+B} &= \pr A + \pr B - \pr {A^\prime  B^\prime }\nonumber\\
    \pr {A+B} &= 0.54 + 0.69 - 0.35 \nonumber\\
	\therefore\pr {A+B} &= 0.88 .\nonumber
\end{align}
...
\begin{align}
	...
	\therefore \pr {A^\prime  B^\prime }&= 1 - 0.88 = 0.12\nonumber
\end{align}
\item We know that,
\begin{align}
	 \pr {({A+B})^\prime} &= \pr A - \pr {AB} \nonumber \\
	 \pr {({A+B})^\prime}&= 0.54 - 0.35 \nonumber \\ 
	 \therefore\pr {({A+B})^\prime}&= 0.19 \nonumber
\end{align}
\item We know that,
\begin{align}
	\pr {B A^\prime} &= \pr B - \pr {A B} \nonumber\\
	\pr {B A^\prime}&= 0.69 - 0.35  \nonumber\\
	\therefore \pr {B A^\prime}&= 0.34. \nonumber
\end{align}
\end{enumerate}
